# SheCodespaces for Django 

[![CC BY-SA 4.0][cc-by-sa-shield]][cc-by-sa]

This repository contains a pre-configured codespace with Python 3.12 and Visual Studio Code for the Web -- all accessible from a web browser.
